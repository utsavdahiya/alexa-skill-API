...
=======
    ('1','1DEP8i3QJCsomS4BSMY2RpU1upv62aGvhD','0x61b21c6ee787bc1df5ef873e5f6809711c62ab92','3MuR2ZgNtfRrkSvAnLewr4uQJiDYdhi2pU'),
    ('2','23EP8i3QJCsomS4BSMY2RpU1upv62aGvhD','0x61asd1c6ee787bc1df5ef873e5f6809711c62ab92','3MuRasd2ZgNtfRrkSvAnLewr4uQJiDYdhi2pU'),
    ('3','1sEP8i3QJCsomS4BSMY2RpU1upv62aGvhD','0x61basdasdc6easde787bc1df5ef873e5f6809711c62ab92','3MuR2ZgNtfRrkSvAnLewr4uQJiDYdhi2pU'),
    ('4','8DEP8i3asdQJCsomS4BSMY2RpU1upv62aGvhD','0x61b212390ee787bc1df5ef873e5f6809711c62ab92','3MuR2ZgNtfRrkSvAnLewr4uQJiDYdhi2pU'),

>>>>>>> facbff95e19e8ada55f236a083a73a04b853c9fe
)

con = lite.connect('crypto_db.db')
...
=======
    create_table = """CREATE TABLE IF NOT EXISTS crypto (id text PRIMARY KEY, btc text , eth text , ltc text, xrp text )"""
    sql = '''INSERT INTO crypto(id,btc,eth,ltc) VALUES(?,?,?,?) '''
>>>>>>> facbff95e19e8ada55f236a083a73a04b853c9fe
    cur = con.cursor()
